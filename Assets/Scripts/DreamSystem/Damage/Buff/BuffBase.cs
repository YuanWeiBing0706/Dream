...
namespace DreamSystem.Damage.Buff
{
    ...
    {
        /// Buff 挂载的目标 GameObject
        protected GameObject mountedTarget;
        ...
        /// </summary>
        public void Initialize(GameObject owner, BuffInstance instance)
        {
            mountedTarget = owner;
        ...
        {
            if (instance == null || instance.buffSystem == null)
            {
                return;
            }

            instance.buffSystem.RemoveTagsFromBlacklist(tags, instance);
        }
    }
}
